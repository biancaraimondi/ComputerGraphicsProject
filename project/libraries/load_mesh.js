...
function parseMTL(text) {
    ...
    const keywords = {
        ...
        Ns(parts)       { material.shininess      = /*parseFloat(parts[0])*/100; },
...
function parseOBJ(text) {
    // because indices are base 1 let's just fill in the 0th objects
    ...
    function addVertex(vert) {
        ...
        ptn.forEach((objIndexStr, i) => {
            ...
            // vertex colors then copy the vertex colors to the webgl vertex color objects
